    ...
    <>
      ...
      <div id='cont_color'>
        ...
        <div className='sec_2'>
          <p className='img'>
            <img
              src='https://static.wixstatic.com/media/63dca8_9c3374dd608947b6b73c32576e3b9782~mv2.jpg/v1/fill/w_851,h_288,al_c,q_80,enc_auto/63dca8_9c3374dd608947b6b73c32576e3b9782~mv2.jpg'
              alt='this is contact us part'
            />
          </p>
          <p className='cont'>Contact with us</p>
        </div>
        <br />
        <br />
        <br />
        ...
        <div className='sec_3'>
          ...
          <br />
          <br />
          Briefly describing why we are the <br /> best and they should contact
          us. <br />
          Things about why they should join <br /> our company for marketing{" "}
          <br />
          purposes, etc.
        </div>
        <span id='head_cont'>
        ...
        <div className='last'>
          The Enterpreneurship <br /> NETWORK
          <br />
